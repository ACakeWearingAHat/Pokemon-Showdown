...
let BattleFormatsData = {
	...
	machamp: {
		...
		randomDoubleBattleMoves: ["bulletpunch", "closecombat", "facade", "knockoff", "poisonjab", "protect", "stoneedge"],
		tier: "UU",
		doublesTier: "DUU",
	},
	machampgmax: {
	...
	seaking: {
		...
		randomDoubleBattleMoves: ["doubleedge", "drillrun", "knockoff", "megahorn", "protect", "waterfall"],
		tier: "(PU)",
		doublesTier: "(DUU)",
	},
	staryu: {
	...
	electivire: {
		...
		randomDoubleBattleMoves: ["crosschop", "earthquake", "flamethrower", "icepunch", "voltswitch", "wildcharge"],
		isNonstandard: "Past",
		tier: "Illegal",
	},
	magby: {
	...
	seismitoad: {
		...
		randomDoubleBattleMoves: ["earthquake", "knockoff", "liquidation", "powerwhip", "protect", "superpower"],
		tier: "OU",
		doublesTier: "(DUU)",
	},
	throh: {
